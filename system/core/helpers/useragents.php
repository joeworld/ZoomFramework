...
/**
*
*Credit Codeigniter, MIT License
*
**/
...
/**
	...
	{
		if (file_exists(APPATH.'config/user_agents.php'))
		{
			include(APPATH.'config/user_agents.php');
			$found = TRUE;
		}

		if ($found !== TRUE)
		{
			die('User Agent file not found, it should be in your application config folder as user_agents.php');
			return FALSE;
		}
